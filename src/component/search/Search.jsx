    ...
    <div>
      <div className={modeChg ? 'nav navOff' : 'nav navOn'}>
          ...
          <div onClick={fucMoon}  className='modetype'>
            <p className={modeChg ? 'mode' : 'mode1'}>{modeChg ? 'LIGHT' : 'DARK'}</p>
            <img src={modeChg ? sun : moon} alt='dark moon icon' className={modeChg ? 'sun' : 'moon'} />
          </div>
        </div>
        ...
        <div className={modeChg ? 'search searchOff' : 'search searchOn'} >
          <div className='searchArea'>
            ...
            <span>
              <input type='text' placeholder='Search GitHub username...' onChange={handlesearch} className={modeChg ? 'searchText1 searchText1::placeholder' : 'searchText searchText::placeholder'}/> 
